# Round Brief — round-0032 (attempt 2)
...
Task: Tick-type-aware deterministic fallback mappings for T3/T5/T6/T7/T8
Review rationale: Hard gate failure: sot_mutation: Canonical SOT mutation detected: canonical SOT file mutated: decisions.md
Unmet: sot_mutation: Canonical SOT mutation detected: canonical SOT file mutated: decisions.md
Fix required: sot_mutation: Canonical SOT mutation detected: canonical SOT file mutated: decisions.md
Hard gate sot_mutation: Canonical SOT mutation detected: canonical SOT file mutated: decisions.md
