# Round Brief — round-0043 (attempt 1)
...
## Selected Task
**Task Key:** P31-T2
**Description:** Add a runtime validation gate that applies P30 acceptance rules and guardrails to each live LLM appraisal result, falling back to deterministic output on any rejection
