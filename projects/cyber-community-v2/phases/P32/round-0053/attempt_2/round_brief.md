# Round Brief — round-0053 (attempt 2)
...
Review rationale: Hard gate failure: allowed_files: Files outside allowed patterns: back/tests/test_social_event_schema.py
Unmet: allowed_files: Files outside allowed patterns: back/tests/test_social_event_schema.py
Fix required: allowed_files: Files outside allowed patterns: back/tests/test_social_event_schema.py
Hard gate allowed_files: Files outside allowed patterns: back/tests/test_social_event_schema.py
