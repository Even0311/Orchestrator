...
## Selected Task
**Task Key:** P32-T6
**Description:** Audit downstream wake behavior after T4 closure — verify that T4-produced residuals carry over across days, appear in subsequent tick contexts, and do not regress T1/T2 continuity that was already stable
