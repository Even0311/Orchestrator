# Round Brief — round-0050 (attempt 1)
...
Human rejected round round-0049 and requested a redo.
Action: reject_and_redo
Human note: Retry P32-T2: prior failure was allowed_files scope + empty commit. Orchestrator now tells Designer about
   rollback.
