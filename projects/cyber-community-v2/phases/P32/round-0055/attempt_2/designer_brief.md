...
## Selected Task
**Task Key:** P32-T3
**Description:** Complete the T4 appraisal-to-residual pipeline so that a detected qualifying event produces a real, persisted relational residual — not just a detection log — closing the gap between event detection and downstream relational effect
...
Task: Complete T4 appraisal-to-residual pipeline for qualifying social events
Review rationale: Hard gate failure: pytest: n_wake_chain_gate_closed_without_residual
FAILED tests/test_t4_threshold_calibration.py::TestCompositionSafety::test_collision_with_residual_t4_absorption_upgraded_to_partial
FAILED tests/test_t4_threshold_calibration.py::TestWakeChainStability::test_wake_gate_closed_no_t4_residual_without_carried_residual
FAILED tests/test_t4_threshold_calibration.py::TestWakeChainStability::test_wake_chain_decays_after_gate_opens
======================== 20 failed, 880 passed in 8.42s ========================

Unmet: pytest: n_wake_chain_gate_closed_without_residual
FAILED tests/test_t4_threshold_calibration.py::TestCompositionSafety::test_collision_with_residual_t4_absorption_upgraded_to_partial
FAILED tests/test_t4_threshold_calibration.py::TestWakeChainStability::test_wake_gate_closed_no_t4_residual_without_carried_residual
FAILED tests/test_t4_threshold_calibration.py::TestWakeChainStability::test_wake_chain_decays_after_gate_opens
======================== 20 failed, 880 passed in 8.42s ========================

Fix required: pytest: n_wake_chain_gate_closed_without_residual
FAILED tests/test_t4_threshold_calibration.py::TestCompositionSafety::test_collision_with_residual_t4_absorption_upgraded_to_partial
FAILED tests/test_t4_threshold_calibration.py::TestWakeChainStability::test_wake_gate_closed_no_t4_residual_without_carried_residual
FAILED tests/test_t4_threshold_calibration.py::TestWakeChainStability::test_wake_chain_decays_after_gate_opens
======================== 20 failed, 880 passed in 8.42s ========================

Hard gate pytest: n_wake_chain_gate_closed_without_residual
FAILED tests/test_t4_threshold_calibration.py::TestCompositionSafety::test_collision_with_residual_t4_absorption_upgraded_to_partial
FAILED tests/test_t4_threshold_calibration.py::TestWakeChainStability::test_wake_gate_closed_no_t4_residual_without_carried_residual
FAILED tests/test_t4_threshold_calibration.py::TestWakeChainStability::test_wake_chain_decays_after_gate_opens
======================== 20 failed, 880 passed in 8.42s ========================
