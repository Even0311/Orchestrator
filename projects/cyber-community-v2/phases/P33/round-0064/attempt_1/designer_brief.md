...
## Selected Task
**Task Key:** P33-T5
**Description:** Run a full multi-day drift audit (30+ simulated days) — measure state-value drift, growth-buffer accumulation patterns, residual stacking behavior, and degradation-rate trends over time, and flag any unbounded or monotonic drift patterns
