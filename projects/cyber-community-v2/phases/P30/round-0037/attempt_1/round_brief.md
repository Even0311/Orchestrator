# Round Brief — round-0037 (attempt 1)
...
## Selected Task
**Task Key:** P30-T2
**Description:** Build a shadow appraisal runner that accepts AppraisalInput, invokes the LLM offline, and returns a parsed AppraisalOutput without touching the live path
...
- **round-0034** [PASSED] — Refactor the settlement application path so that all four settlement functions (
