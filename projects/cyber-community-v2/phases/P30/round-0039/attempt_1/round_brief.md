# Round Brief — round-0039 (attempt 1)
...
## Selected Task
**Task Key:** P30-T4
**Description:** Build a comparison harness that runs both deterministic and shadow LLM paths on the same AppraisalInput, produces a structured diff report, and flags acceptance-rule violations
...
- **round-0036** [PASSED] — Define the data schema and rendering contract that converts an AppraisalInput in
