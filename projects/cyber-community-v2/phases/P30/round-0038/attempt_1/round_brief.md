# Round Brief — round-0038 (attempt 1)
...
## Selected Task
**Task Key:** P30-T3
**Description:** Define acceptance rules that specify per-field comparison criteria between LLM-produced and deterministic AppraisalOutput, distinguishing structural validity from semantic quality
...
- **round-0035** [PASSED] — Add a dedicated test file (test_p29_t6_boundary_contract.py) that validates the 
