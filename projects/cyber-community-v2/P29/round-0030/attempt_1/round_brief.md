# Round Brief — round-0030 (attempt 1)
...
## Selected Task
**Task Key:** P29-T1
**Description:** Define a unified AppraisalInput schema that represents all 8 tick types with their context slices
...
- **round-0027** [DISMISSED] — Confirm that Pattern A (Contested Endorsement) and Pattern B (High-Intensity Uni
